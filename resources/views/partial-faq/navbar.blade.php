    ...
    <ul class="nav navbar-nav">
        ...
        <li class="menu-dropdown mega-menu-dropdown ">
            <a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
                Journals A-Z <i class="fa fa-angle-down"></i>
            </a>
        ...
        <li class="menu-dropdown mega-menu-dropdown mega-menu-full ">
            <a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
                Arts & Humanities<i class="fa fa-angle-down"></i>
            </a>
        ...
        <li class="menu-dropdown classic-menu-dropdown ">
            <a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;">
                Medicine & Health <i class="fa fa-angle-down"></i>
            </a>
        ...
        <li class="menu-dropdown mega-menu-dropdown mega-menu-full active">
            <a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
                Science & Mathmatics <i class="fa fa-angle-down"></i>
            </a>
            <ul class="dropdown-menu">
                <li>
                    <div class="mega-menu-content">
                                ...
                                <ul class="mega-menu-submenu">
                                    ...
                                    <li>
                                        <a href="page_timeline.html">
                                            <i class="fa fa-angle-right"></i>
                                            Pure Physics <span class="badge badge-warning">2</span></a>
                                    </li>
                                    <li>
                                        <a href="extra_profile.html">
                                            <i class="fa fa-angle-right"></i>
                                            Applied Physics <span class="badge badge-success badge-roundless">new</span></a>
                                    </li>
                                    <li>
                                        <a href="page_todo.html">
                                            <i class="fa fa-angle-right"></i>
                                            Electronics <span class="badge badge-danger">4</span></a>
                                    </li>
                                    <li>
                                        <a href="inbox.html">
                                            <i class="fa fa-angle-right"></i>
                                            Electrical <span class="badge badge-success">4</span></a>
                                    </li>
                                    <li>
                                        <a href="page_calendar.html">
                                            <i class="fa fa-angle-right"></i>
                                            Sky Science <span class="badge badge-warning">14</span></a>
                                    </li>
                                    <li>
                                        <a href="page_timeline_old.html">
                                            <i class="fa fa-angle-right"></i>
                                            Classical Physics <span class="badge badge-warning">2</span></a>
                                    </li>
                                    <li>
                            ...
                            <div class="col-md-3">
                                <ul class="mega-menu-submenu">
                                    ...
                                    <li>
                                        <a href="page_timeline.html">
                                            <i class="fa fa-angle-right"></i>
                                            Organic Chemistry <span class="badge badge-info">4</span></a>
                                    </li>
                                    <li>
